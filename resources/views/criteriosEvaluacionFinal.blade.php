...
<div class="container">
    ...
    <form action="{{ route('crearEvaluacionFinal') }}" method="POST">
        @csrf
        <div class="form-row">
            <div class="col-md-6">
            ...
            <div class="col-md-3 ">
                <div class="input-group mb-2 mr-sm-2">
                    <div class="input-group-prepend">
                        ...
                        <input type="text" name="pagina"  value="{{ $evaluacion->pagina }}" class="form-control" id="inlineFormInputGroupUsername2" >
                </div>
            </div> 
            ...
            <div class="col-md-3 ">
                <div class="input-group mb-2 mr-sm-2">
                    <div class="input-group-prepend">
                        ...
                        <input type="text" name="pagina_de" value="{{ $evaluacion->pagina_de }}" class="form-control" id="inlineFormInputGroupUsername2" >
                </div>
            </div> 
